...
function getAll() {
    ...
    var url = "http://localhost:1874/ServiceArticle.svc/GetArticleList";
    $.ajax({
        type: "GET",
        url: url,
...
$('#SelectArticle').change(function () {
    ...
    if (valorSelect != '0') {
        ...
        var url = "http://localhost:1874/ServiceArticle.svc/GetArticle/" + valorSelect;
        $.ajax({
            type: "GET",
            url: url,
            contentType: "application/json; charset=utf-8",
...
document.getElementById("BtnAgregar").onclick = function () {
    ...
    if (document.getElementById("TxtTotal").value.trim() == "") { document.getElementById("TxtTotal").value = subtotal; }
    else {
        document.getElementById("TxtTotal").value = parseInt(document.getElementById("TxtTotal").value) + subtotal;
    }
...
document.getElementById("BtnGuardarTransaccion").onclick = function () {
    ...
    if (total != '0') {
        ...
        var url = "http://localhost:1874/ServiceArticle.svc/AddVentaList/" + fecha + "/" + total;
        $.ajax({
            type: "POST",
            url: url,
            contentType: "application/json; charset=utf-8",
